...
The public API lives at the module root (`github.com/go-ruby-timecop/timecop`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `timecop`, while the surface follows
...
```go
import "github.com/go-ruby-timecop/timecop"
```
...
- **[pkg.go.dev/github.com/go-ruby-timecop/timecop](https://pkg.go.dev/github.com/go-ruby-timecop/timecop)**

The module's [README](https://github.com/go-ruby-timecop/timecop#readme) carries worked
