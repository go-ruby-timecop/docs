...
Contributions are welcome. `go-ruby-timecop/timecop` is built to a small set of
...
The library is in [`github.com/go-ruby-timecop/timecop`](https://github.com/go-ruby-timecop/timecop).
This documentation site is in [`github.com/go-ruby-timecop/docs`](https://github.com/go-ruby-timecop/docs).
