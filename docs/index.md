# go-ruby-timecop documentation

**Pure-Go Timecop: freeze/travel/scale time for tests, CGO=0 — bound into rbgo**

`go-ruby-timecop/timecop` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `timecop`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `timecop`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`timecop`](https://github.com/go-ruby-timecop/timecop) | the library — Ruby's `timecop` in pure Go |
| [`docs`](https://github.com/go-ruby-timecop/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-timecop.github.io`](https://github.com/go-ruby-timecop/go-ruby-timecop.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-timecop/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-timecop/timecop](https://github.com/go-ruby-timecop/timecop).
